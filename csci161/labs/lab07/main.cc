...
int main()
{
    ComplexNum n1(3.5, 7.0); // 3.5 + 7.0i
    ComplexNum n2;  // 0 + 0i, default constructor
    ...
    cout << "new number 1: " << n1 << endl
	 << "new number 2: " << n2 << endl;
    
    ComplexNum n3 = (++n2); // incremental operator & copy contructor
    ComplexNum n4 = -n1; // negation and copy constructor
